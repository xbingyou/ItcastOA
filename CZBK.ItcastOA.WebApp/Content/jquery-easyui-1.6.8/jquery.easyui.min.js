...
(function ($) {
    ...
    $.fn.pagination.defaults = {
        total: 1, pageSize: 10, pageNumber: 1, pageList: [10, 20, 30, 50], loading: false, buttons: null, showPageList: true, showPageInfo: true, showRefresh: false, links: 10, layout: ["list", "sep", "first", "prev", "sep", "manual", "sep", "next", "last", "sep", "refresh", "info"], onSelectPage: function (_d2, _d3) {
...
(function ($) {
    ...
    function _737(_738) {
        ...
        if (opts.pagination) {
            ...
            _73f.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_740, _741) {
    ...
    function _74e(_74f) {
        ...
        _754.each(function () {
            $(this).resizable({
                handles: _755, edge: opts.resizeEdge, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _750.resizing = true;
...
(function ($) {
    ...
    function _952(_953) {
        ...
        $(_953).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_955, row) {
...
(function ($) {
    function _9b8(_9b9) {
        ...
        if (opts.pagination) {
            ...
            _9c5.pagination({
                pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_9c6, _9c7) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, animate: false, singleSelect: true, view: _a5d, rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _9d3(true), mouseout: _9d3(false), click: _9d5 }), loader: function (_a9b, _a9c, _a9d) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
...
(function ($) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        fitColumns: true, singleSelect: true, showHeader: false, checkbox: false, lines: false, valueField: "value", textField: "text", groupField: "", view: _aad, textFormatter: function (_ac9, row) {
            return _ac9;
...
(function ($) {
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: { click: _ade, keydown: _ae2, paste: _ae2, drop: _ae2, blur: _ae5 }, panelEvents: {
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupPosition: "static", groupField: null, groupFormatter: function (_b6e) {
            return _b6e;
        }, mode: "local", method: "post", url: null, data: null, queryParams: {}, showItemIcon: false, limitToList: false, unselectedValues: [], mappingRows: [], view: _b69, keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
...
(function ($) {
    ...
    $.fn.tagbox.defaults = $.extend({}, $.fn.combobox.defaults, {
        hasDownArrow: false, multiple: true, reversed: true, selectOnNavigation: false, tipOptions: $.extend({}, $.fn.textbox.defaults.tipOptions, { showDelay: 200 }), val: function (_c49) {
...
(function ($) {
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_cdb) {
            return _cdb;
        }, converter: {
